//création d'un programme qui va écouter des requetes http et y repondre
//pour ça il faut importer le package http de NODE
const http = require('http');//require est la commande pour importer le package
